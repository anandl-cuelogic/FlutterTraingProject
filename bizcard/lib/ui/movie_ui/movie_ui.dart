    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(child: MovieDetailsHeader(movieDetails: movie))
        ],
      ),
    );
  }
...
class MovieDetailsHeader extends StatelessWidget {
  ...
  const MovieDetailsHeader({Key key, this.movieDetails}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        Text(
          "${movieDetails.year} . ${movieDetails.genre}".toUpperCase(),
        ...
        Text.rich(TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(text: movieDetails.plot),
              TextSpan(
...
class MovieDetailExtractPoster extends StatelessWidget {
  final List<String> posterImage;

  const MovieDetailExtractPoster({Key key, this.posterImage}) : super(key: key);
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => ClipRRect(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(posterImage[index]),
                        fit: BoxFit.cover
                    )
                ),
              ),
